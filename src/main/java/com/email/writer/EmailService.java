...
public class EmailService {
    ...
    public String genarateReply(EmailRequest emailRequest){
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate proper reply for for the following email content like pro. Please don't generate a subject line ");
